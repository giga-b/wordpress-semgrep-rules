<?php
/**
 * GamiPress Show Content If Shortcode
 *
 * @package     GamiPress\Restrict_Content\Shortcodes\Shortcode\GamiPress_Show_Content_If
 * @since       1.0.0
 */
...
/**
 * Register the [gamipress_show_content_if] shortcode.
 *
 * @since 1.0.2
 */
function gamipress_register_show_content_if_shortcode() {

    gamipress_register_shortcode( 'gamipress_show_content_if', array(
        'name'              => __( 'Show Content If', 'gamipress-restrict-content' ),
        'description'       => __( 'Show a portion of content if user meets a specific condition.', 'gamipress-restrict-content' ),
        'icon'              => 'lock',
        'group'             => 'restrict_content',
        'output_callback'   => 'gamipress_show_content_if_shortcode',
        'fields'      => array(

            'condition' => array(
                'name'        => __( 'Condition', 'gamipress-restrict-content' ),
                'description' => __( 'Choose the condition that user needs to meet to show the portion of content.', 'gamipress-restrict-content' ),
                'type' 	=> 'select',
            ...
            'points' => array(
                ...
                'description'   => __( 'Points amount required to show the portion of content.', 'gamipress-restrict-content' ),
                'type' 	        => 'text',
                'default'       => '100'
            ),
            'points_type' => array(
                'name'          => __( 'Points Type', 'gamipress-restrict-content' ),
                'description'   => __( 'The points amount points type required to show the portion of content.', 'gamipress-restrict-content' ),
                'type' 	        => 'select',
            ...
            'achievement' => array(
                ...
                'description'   => __( 'The achievement(s) required to show the portion of content.', 'gamipress-restrict-content' ),
            ...
            'achievement_type' => array(
                ...
                'description'   => __( 'The achievement type required to show the portion of content.', 'gamipress-restrict-content' ),
                'type' 	=> 'select',
            ...
            'achievement_count' => array(
                ...
                'description'   => __( 'Number of achievements required to show the portion of content.', 'gamipress-restrict-content' ),
                'type' 	        => 'text',
            ...
            'rank' => array(
                ...
                'description'   => __( 'The rank(s) required to show the portion of content.', 'gamipress-restrict-content' ),
                'type'          => 'advanced_select',
                'multiple'      => true,
                'classes' 	    => 'gamipress-post-selector',
                'attributes' 	=> array(
            ...
            'message' => array(
                ...
                'desc'          => __( 'Text that is shown to users that doesn\'t meets the condition. Available tags:', 'gamipress-restrict-content' )
...
add_action( 'init', 'gamipress_register_show_content_if_shortcode' );
 ...
 */
function gamipress_show_content_if_shortcode( $atts = array(), $content = '' ) {
    ...
    $atts = shortcode_atts( array(
        ...
        // Support for blocks
        'content'           => '',
    ), $atts, 'gamipress_show_content_if' );
    ...
    if( gamipress_restrict_content_user_meets_condition( $atts['condition'], $user_id, $atts ) ) {
        ...
        // if meets the condition, the output will be the portion of content
        $output = $content;
         ...
         * @param string    $content    Shortcode content
         */
        $output = apply_filters( 'gamipress_show_content_if_shortcode_granted_output', $output, $atts, $content );
         ...
         * @param string    $content    Shortcode content
         */
        $output = apply_filters( 'gamipress_show_content_if_shortcode_restricted_output', $output, $atts, $content );
     ...
     * @param string    $content    Shortcode content
     */
    return apply_filters( 'gamipress_show_content_if_shortcode_output', $output, $atts, $content );
}
