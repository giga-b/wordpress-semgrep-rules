 ...
 * @since 1.0.0
 */
function gamipress_leaderboards_admin_menu() {
    $minimum_role = gamipress_get_manager_capability();
    add_submenu_page( 'gamipress', __( 'Leaderboards', 'gamipress-leaderboards' ), __( 'Leaderboards', 'gamipress-leaderboards' ), $minimum_role, 'edit.php?post_type=gp_leaderboard', false );
}
add_action( 'admin_menu', 'gamipress_leaderboards_admin_menu', 20 );
...
add_action( 'admin_bar_menu', 'gamipress_leaderboards_admin_bar_menu', 999 );
...
function gamipress_leaderboards_meta_boxes() {
    ...
    gamipress_add_meta_box(
        ...
        array(
            ...
            $prefix . 'hide_no_earners' => array(
                'name' 	        => __( 'Hide Users Without Earnings', 'gamipress-leaderboards' ),
                'desc' 	        => __( 'Hide users who all their earnings are zero (for ranks is considered the lowest priority rank as no earning).', 'gamipress-leaderboards' ),
                'type' 	        => 'checkbox',
                'classes'       => 'gamipress-switch',
                'default_cb'    => 'gamipress_cmb2_checkbox_enabled_by_default',
            ),
