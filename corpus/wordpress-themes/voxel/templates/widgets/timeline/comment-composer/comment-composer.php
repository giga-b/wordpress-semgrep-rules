...
?>
<script type="text/html" id="vxfeed__comment-composer">
	<div class="vxf-create-post vxf-create-comment flexify" :class="{'vxf-expanded': isExpanded}" ref="wrapper" :id="uniqueId" @dragenter="onDragEnter">
		...
		<div class="vxf-create-post__content">
			...
			<textarea
				...
				placeholder="<?= esc_attr( _x( 'Post a reply', 'timeline', 'voxel' ) ) ?>"
			...
			<div v-if="isExpanded" class="vxf-footer-wrapper">
				...
				<div class="vxf-footer flexify">
					...
					<div class="vxf-buttons flexify">
						<a href="#" @click.prevent="onCancel" class="ts-btn ts-btn-1"><?= _x( 'Cancel', 'timeline comments', 'voxel' ) ?></a>
						<a href="#" @click.prevent="publish" class="ts-btn ts-btn-2" :class="{'vx-pending': submitting}">
							...
							<template v-else>
								<template v-if="comment">
									<?= _x( 'Update', 'timeline comments', 'voxel' ) ?>
								</template>
								<template v-else>
									<?= _x( 'Reply', 'timeline comments', 'voxel' ) ?>
								</template>
							</template>
						</a>
					</div>
