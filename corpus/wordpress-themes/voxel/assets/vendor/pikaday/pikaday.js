...
}(this, function (moment)
{
    ...
    renderDay = function(opts, instance)
    {
        var arr = [];
        ...
        if ( Array.isArray( opts.customClasses ) ) {
        	arr.push( ...opts.customClasses );
        }
        ...
        if ( typeof instance._o.dayRenderHook === 'function' ) {
        	instance._o.dayRenderHook( opts, slots );
        }
    ...
    renderTitle = function(instance, c, year, month, refYear, randId)
    {
        ...
        let arrowLeft = `<svg fill="#1C2033" width="52" height="52" version="1.1" id="lni_lni-arrow-left" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
...
<path d="M56,29.8H13.3l17-17.3c0.9-0.9,0.9-2.3,0-3.2c-0.9-0.9-2.3-0.9-3.2,0l-20.7,21c-0.9,0.9-0.9,2.3,0,3.2l20.7,21
	...
	z"/>
		...
		let arrowRight = `<svg fill="#1C2033" width="52" height="52" version="1.1" id="lni_lni-arrow-right" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<path d="M57.6,30.4l-20.7-21c-0.9-0.9-2.3-0.9-3.2,0c-0.9,0.9-0.9,2.3,0,3.2l16.8,17.1H8c-1.2,0-2.2,1-2.2,2.2s1,2.3,2.2,2.3h42.7
	l-17,17.3c-0.9,0.9-0.9,2.3,0,3.2c0.4,0.4,1,0.6,1.6,0.6c0.6,0,1.2-0.2,1.6-0.7l20.7-21C58.5,32.7,58.5,31.3,57.6,30.4z"/>
        ...
        if (c === 0) {
            html += '<button class="pika-prev ts-icon-btn' + (prev ? '' : ' is-disabled') + '" type="button">' + opts.i18n.previousMonth + arrowLeft + '</button>';
        }
        if (c === (instance._o.numberOfMonths - 1) ) {
            html += '<button class="pika-next ts-icon-btn' + (next ? '' : ' is-disabled') + '" type="button">' + opts.i18n.nextMonth + arrowRight + '</button>';
        }
        ...
        render: function(year, month, randId)
        {
            ...
            for (var i = 0, r = 0; i < cells; i++)
            {
                var day = new Date(year, month, 1 + (i - before)),
                    ...
                    customClasses = opts.customClassesFn && opts.customClassesFn(day),
                ...
                row.push(renderDay(dayConfig, this));
