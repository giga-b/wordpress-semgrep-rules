...
class User_Received_Message_Event extends \Voxel\Events\Base_Event {
	...
	public function get_description(): ?string {
		return 'This event is throttled: it is triggered if at least 15 minutes have passed since the previous interaction. It does not run continuosly while two users are chatting.';
	}
	...
	public function set_mock_props() {
		...
		$this->message = \Voxel\Direct_Messages\Message::mock();
	}
