...
class Post_Updated_Event extends \Voxel\Events\Base_Event {
	...
	public function get_label(): string {
		return sprintf( '%s: User updated their post', $this->post_type->get_label() );
	}
		...
		return [
			'post_author' => [
				...
				'email' => [
					...
					'subject' => 'Your post has been updated.',
					'message' => <<<HTML
					Your post <strong>@post(:title)</strong> has been updated.
