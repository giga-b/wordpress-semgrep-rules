...
function subtle_file_upload_bypass_complex_vulnerable_function() {
    global $wpdb;
...
add_action('init', 'subtle_file_upload_bypass_complex_vulnerable_function');
