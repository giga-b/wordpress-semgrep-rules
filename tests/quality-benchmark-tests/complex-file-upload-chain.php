...
function complex_file_upload_chain_complex_vulnerable_function() {
    global $wpdb;
...
add_action('init', 'complex_file_upload_chain_complex_vulnerable_function');
