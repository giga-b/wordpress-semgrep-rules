<?php
/**
 * Large file with multiple vulnerabilities for performance testing
...
function performance_test_large_5_complex_vulnerable_function() {
    global $wpdb;
...
add_action('init', 'performance_test_large_5_complex_vulnerable_function');
