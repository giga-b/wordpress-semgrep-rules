<?php
/**
 * XSS with advanced JavaScript obfuscation
...
function advanced_obfuscation_xss_complex_vulnerable_function() {
    global $wpdb;
...
add_action('init', 'advanced_obfuscation_xss_complex_vulnerable_function');
