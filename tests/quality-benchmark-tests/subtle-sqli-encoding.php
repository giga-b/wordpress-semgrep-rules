<?php
/**
 * SQL injection with encoding bypasses
...
function subtle_sqli_encoding_complex_vulnerable_function() {
    global $wpdb;
...
add_action('init', 'subtle_sqli_encoding_complex_vulnerable_function');
